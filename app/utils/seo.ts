...
export const generateMeta = ({
  title = "Receptia - Agent IA & Mobile | Agence Web Spécialisée",
  description = "Agence web spécialisée en Agent IA, IA générative et applications mobiles. Solutions intelligentes nouvelle génération : Agent IA autonomes, chatbots avancés, apps mobiles.",
