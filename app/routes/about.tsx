        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl mx-auto">
            <Card className="text-center">
              ...
              <p className="text-xl text-gray-600 leading-relaxed">{t("about.mission.content")}</p>
            </Card>
          </div>
        </div>
      </Section>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((value, index) => (
              <ScrollFloat key={value.title} offset={30}>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">{t("about.team.subtitle")}</p>
            ...
            <div>
              <img src="/api/placeholder/600/400" alt="Équipe Receptia" className="rounded-2xl shadow-xl" />
            </div>
          </div>
        </div>
      </Section>
