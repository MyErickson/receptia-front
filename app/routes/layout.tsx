        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400 mb-4">Votre partenaire IA & Digital de confiance</p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link to="/services#ai_apps" className="text-gray-400 hover:text-white transition-colors">
                    Applications IA
                  </Link>
                </li>
                <li>
                  <Link to="/services#showcase" className="text-gray-400 hover:text-white transition-colors">
            ...
            <div>
              <h4 className="font-semibold mb-4 text-white">{t("footer.contact.title")}</h4>
              <ul className="space-y-2 text-gray-400">
                <li>
                  <a href="mailto:contact@receptia.fr" className="hover:text-white transition-colors">
