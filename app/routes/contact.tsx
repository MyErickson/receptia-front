			...
			<div className="container mx-auto px-4 sm:px-6 lg:px-8">
				...
				<div className="grid lg:grid-cols-3 gap-12 max-w-6xl mx-auto">
									...
									<div>
										...
										>
											...
											<option value="showcase">
												{t("contact.form.budgetOptions.showcase")}
											</option>
											<option value="small">
												{t("contact.form.budgetOptions.small")}
											</option>
											<option value="medium">
												{t("contact.form.budgetOptions.medium")}
											</option>
											<option value="large">
												{t("contact.form.budgetOptions.large")}
											</option>
											<option value="discuss">
												{t("contact.form.budgetOptions.discuss")}
											</option>
										</select>
									</div>
									<div>
										...
										>
											<option value="">Sélectionner...</option>
											<option value="asap">
												{t("contact.form.timelineOptions.asap")}
											</option>
											<option value="month">
					...
					<div className="space-y-6">
						...
						<Card>
							<h3 className="text-xl font-bold mb-4">
								{t("contact.alternatives.meeting")}
							</h3>
							<p className="text-gray-600 mb-4">
								Préférez-vous discuter de vive voix ? Réservez un créneau de 30
								minutes avec notre équipe.
							</p>
							<Button
								href="https://calendly.com/receptia"
								external
								fullWidth
								variant="secondary"
							>
