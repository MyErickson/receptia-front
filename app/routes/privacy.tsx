...
export function meta(_: Route.MetaArgs) {
	return generateMeta({
		...
		description: "Politique de confidentialité de Receptia. Protection des données personnelles dans nos solutions d'intelligence artificielle et services digitaux.",
	});
}
				...
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					<div className="max-w-4xl mx-auto">
						...
						>
							...
							<div className="w-24 h-1 bg-gradient-to-r from-green-500 to-blue-600 rounded-full mx-auto mt-6"></div>
						</motion.div>
								...
								<div className="flex items-start space-x-4">
									...
									<div>
										...
										<p className="text-gray-600">
											Chez Receptia, la protection de vos données personnelles est notre priorité. Cette politique détaille comment nous collectons, utilisons et protégeons vos informations conformément au RGPD.
										</p>
									</div>
								</div>
							</Card>
							...
							<Card className="bg-gradient-to-r from-gray-50 to-green-50 border border-gray-200">
								<div className="text-center">
									...
									<p className="text-gray-600 mb-6">
										Notre délégué à la protection des données est à votre écoute pour répondre à toutes vos questions.
									</p>
